...
public class Field {
    ...
    /**
     * Tenta encontrar um local livre adjacente ao local fornecido. Se 
     * não houver nenhum, retorna a localização atual se estiver livre. Se não,
     * return null. O local retornado estará dentro dos limites válidos do campo.
     *
     * @param location Localização atual do objeto
     * @return Retorna um novo local válido caso esteja espaços disponíveis ou 
     * a própria posição caso esteja com o campo cheio
     */
    ...
    public List<Location> getFreeAdjacentLocations(Location location)
    {
     ...
     /**
     * Retorna uma nova posição adjacente para o objeto caso esteja disponível
     * caso o campo esteja cheio retorna nulo
     * @param location Localização atual do objeto
     * @return Retorna um local válido se tiver espaços disponíveis, caso não retorna nulo
     */
